...
# for Fig S3D-F, do not split lines.

## combined lines, use 1-tailed test #####

plot_Glut_subset <- Glut_subset
...
ggplot(df_test,
  ...
  ggtitle(paste("combined, VPS45 expression;",
...
ggplot(df_test,
  ...
  theme(axis.title.x = element_blank(),
        legend.position = "none",
        axis.text = element_text(size = 12)) +
  ggtitle(paste("combined, PBRM1 expression;",
                "Student's t-test (two-sided, non-parametric)",
                "P value = 0.017",
                sep = "\n"))
...
ggplot(df_test,
  ...
  theme(axis.title.x = element_blank(),
        legend.position = "none",
        axis.text = element_text(size = 12)) +
  ggtitle(paste("combined, GNL3 expression;",
                "Student's t-test (two-sided, non-parametric)",
                "P value = 0.044",
                sep = "\n"))
