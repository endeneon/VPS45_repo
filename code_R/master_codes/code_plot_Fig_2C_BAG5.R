...
for (i in 1:3) {
  VPS45_data_list[[i]] <-
    read_excel("Fig2C/Fig_2C_BAG5.xlsx", 
               sheet = i)
  VPS45_data_list[[i]] <-
...
min(VPS45_data_list[[1]]$start) #103333544
max(VPS45_data_list[[1]]$stop) #103847590
# rs7248456: chr14:103561933 
...
plot_gene_track(chr = "chr14",
                start = 103300000,
                end = 103850000, 
                SNP_position = 103561933,
                SNP_id = "rs7148456",
                # x_offset_1 = 250000, x_offset_2 = 250000,
                title_name = "NGN2-Glut")


# rs7148456: chr14:103561933 
min(VPS45_data_list[[1]]$start) #103333544
max(VPS45_data_list[[1]]$stop) #103847590
