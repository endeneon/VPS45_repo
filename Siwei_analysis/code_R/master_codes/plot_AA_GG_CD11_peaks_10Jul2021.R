...
# Siwei 10 Jun 2021
# Use bigWig tracks generated by ATACQC with fold-changes
# as calculated by signal/local lambda model
# Siwei 04 Jun 2021
...
plot_anywhere <- function(chr, start, end, gene_name = "",
  ...
  #                        end = end,
  #                        name = "AA-1")
  dTrack_AA_1 <- DataTrack(range = "NGN2_rs2027349_AA_GG_bigWig/R-AA-1_S14_R1_001.trim.srt.nodup.no_chrM_MT.tn5.fc.signal.bigwig",
                           ...
                           name = "AA-1")
  dTrack_AA_2 <- DataTrack(range = "NGN2_rs2027349_AA_GG_bigWig/R-AA-2_S15_R1_001.trim.srt.nodup.no_chrM_MT.tn5.fc.signal.bigwig",
                         genome = "hg38", type = "horizon", 
                         col.title = "black",
                         col.axis = "black", rotation.title = 90,
                         fontcolor = "black", fontsize = 16,
                         ...
                         name = "AA-2")
  dTrack_GG_1 <- DataTrack(range = "NGN2_rs2027349_AA_GG_bigWig/R-GG-1_S16_R1_001.trim.srt.nodup.no_chrM_MT.tn5.fc.signal.bigwig",
                         genome = "hg38", type = "horizon", 
                         col.title = "black",
                         col.axis = "black", rotation.title = 90,
                         fontcolor = "black", fontsize = 16,
                         ...
                         name = "GG-1")
  dTrack_GG_2 <- DataTrack(range = "NGN2_rs2027349_AA_GG_bigWig/R-GG-2_S17_R1_001.trim.srt.nodup.no_chrM_MT.tn5.fc.signal.bigwig",
                         genome = "hg38", type = "horizon", 
                         col.title = "black",
                         col.axis = "black", rotation.title = 90,
                         fontcolor = "black", fontsize = 16,
